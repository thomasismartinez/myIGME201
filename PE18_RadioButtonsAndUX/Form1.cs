    ...
    public partial class PersonEditForm : Form
    {
        ...
        public PersonEditForm(Person person, Form parentForm)
        {
            ...
            */
            ...
            if (person.GetType() == typeof(Student))
            {
                ...
                //check class year radio button based on class year (default to senior)
            ...
            // check gender "them" if person is new
            if (person.name == null)
            {
                themRadioButton.Checked = true;
            }
            // else check button according to known gender pronoun
            else
            {
        ...
        private void TypeComboBox__SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                // set classGroupBox Visible field = false
        ...
        private void OkButton__Click(object sender, EventArgs e)
        {
            ...
            if (themRadioButton.Checked)
            {
                person.eGender = genderPronoun.them;
            }
            else if (himRadioButton.Checked)
            {
        ...
        private void ClassRadioButton__CheckedChange(object sender, EventArgs e)
        {
            //cast sender to radio button
            RadioButton rb = (RadioButton)sender;
            ...
            if (rb.Checked)
            {
                ...
                else if (freshRadioButton.Checked)
                {
        ...
        {
            ClassRadioButton__CheckedChange(sender, e);
        }
